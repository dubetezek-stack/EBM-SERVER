...
var API = {
  token: (function() { try { return localStorage.getItem('token'); } catch(e) { return null; } })(),
  ...
  post: function(url, body) { return this.request(url, { method: 'POST', body: body }); },
  put: function(url, body) { return this.request(url, { method: 'PUT', body: body }); },
  del: function(url) { return this.request(url, { method: 'DELETE' }); },

  uploadFiles: function(driveId, subpath, files, onProgress) {
    var self = this;
    return new Promise(function(resolve, reject) {
      ...
      xhr.onload = function() { xhr.status === 200 ? resolve(JSON.parse(xhr.responseText)) : reject(new Error('Upload falhou')); };
